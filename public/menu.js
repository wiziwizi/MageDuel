...
//Buttons
let startButtonTexture = PIXI.Texture.fromImage('images/button1.png');
let startButtonTextureGlow = PIXI.Texture.fromImage('images/button2.png');
let startButtonImages = [startButtonTexture, startButtonTexture, startButtonTextureGlow];

let tutButtonTexture = PIXI.Texture.fromImage('images/button1.png');
let tutButtonTextureGlow = PIXI.Texture.fromImage('images/button2.png');
let tutButtonImages = [tutButtonTexture, tutButtonTexture, tutButtonTextureGlow];

let backButtonTexture = PIXI.Texture.fromImage('images/button1.png');
let backButtonTextureGlow = PIXI.Texture.fromImage('images/button2.png');
let backButtonImages = [backButtonTexture, backButtonTexture, backButtonTextureGlow];

//Images
let backgroundTexture = PIXI.Texture.fromImage('images/background.png');
let backgroundSprite = new PIXI.Sprite(backgroundTexture);
let tutBackgroundSprite = new PIXI.Sprite(backgroundTexture);

let menuBackgroundTexture = PIXI.Texture.fromImage('images/menubg.png');
