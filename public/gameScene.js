...
//button textures
let buttonTexture = [PIXI.Texture.fromImage('images/buttons/fire.png'),
                    PIXI.Texture.fromImage('images/buttons/water.png'),
                    PIXI.Texture.fromImage('images/buttons/electricity.png'),
                    PIXI.Texture.fromImage('images/buttons/ground.png'),
                    PIXI.Texture.fromImage('images/buttons/wind.png'),
                    PIXI.Texture.fromImage('images/buttons/arcane.png')];

let hoverTexture = [PIXI.Texture.fromImage('images/buttons/fire2.png'),
                    PIXI.Texture.fromImage('images/buttons/water2.png'),
                    PIXI.Texture.fromImage('images/buttons/electricity2.png'),
                    PIXI.Texture.fromImage('images/buttons/ground2.png'),
                    PIXI.Texture.fromImage('images/buttons/wind2.png'),
                    PIXI.Texture.fromImage('images/buttons/arcane2.png')];

let readyTexture1 = PIXI.Texture.fromImage('images/buttons/ready.png');
let readyTexture2 = PIXI.Texture.fromImage('images/buttons/ready2.png');
...
//players
let playerTexture1 = PIXI.Texture.fromImage('images/junkrat.png');
let playerTexture2 = PIXI.Texture.fromImage('images/cat.png');
